    ...
    class CreateRecipe {
        ...
        void createRecipe_WithAuth_ReturnsCreatedRecipe() throws Exception {
            ...
            CreateRecipeRequestDto request = new CreateRecipeRequestDto(
                    ...
                    null,
                    List.of(new IngredientDto("Salt", 1.0, MeasurementUnit.TSP, IngredientType.SEASONING, null)),
    ...
    class RecipeLineage {
        ...
        void createVariant_WithParent_SetsLineage() throws Exception {
            ...
            CreateRecipeRequestDto request = new CreateRecipeRequestDto(
                    ...
                    testFood.getPublicId(),
                    null,
                    List.of(new IngredientDto("Extra Spice", 2.0, MeasurementUnit.TSP, IngredientType.SEASONING, null)),
                    List.of(new StepDto(1, "Add spice and mix well", null, null, null)),
                    List.of(testImage.getPublicId()),
                    "INGREDIENT_CHANGE",
