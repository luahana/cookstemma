      ...
      <div className="relative">
        ...
        <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-2">
          ...
          <button
            type="submit"
            disabled={isPending}
            className="px-4 py-1.5 bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary-dark)] transition-colors text-sm font-medium disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isPending ? (
              <>
